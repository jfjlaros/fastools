...
class UMIExtractor(object):
    ...
    def append_umi_identifier_to_read_header(self, description, identifier):
        ...
        if header_format == 'x':
            ...
            return '{}_{} {}'.format(description_splitted_part1, identifier, description_splitted_part2)
    ...
    def extract_from_start(self, record):
        ...
        :arg SeqIO record: sequence record
        :return str,str,str: extracted UMI sequence, fixed sequence, fixed quality
        """
